...
const Liner = ({open,count}) => {
  ...
  return (
    <div className="flex justify-between px-3 my-[4pc] lg:px-8 w-full ">
       ...
       <span className="text-lg border-b-2 lg:p-0 pl-2  border-solid  "><a href="/inventory">Pantry🥗<span className=" bg-white ml-1  text-black rounded-full py-1 px-2 text-md">{localStorage.getItem('count')}</span></a></span>
